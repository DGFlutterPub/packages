...
import 'package:dghub_id_card_verification/src/overlay/model.dart';
import 'package:dghub_id_card_verification/src/overlay/overlay_shape.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: [
        ...
        if (widget.enabled) OverlayShape(widget.model),
